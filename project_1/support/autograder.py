...
def readCommand(argv):
    ...
    parser.set_defaults(generateSolutions=False, edxOutput=False, muteOutput=False, printTestCase=False, \
                        noGraphics=False, graphics=False, gsOutput=False)
    ...
    parser.add_option('--gradescope-output',
                    dest = 'gsOutput',
                    action = 'store_true',
                    help = 'Generate Gradescope compatible output')
...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP, edxOutput=False, gsOutput=False, \
            muteOutput=False, printTestCase=False, questionToGrade=None, display=None):
    ...
    grades = grading.Grades(projectParams.PROJECT_NAME, questions, edxOutput=edxOutput, muteOutput=muteOutput, gsOutput=gsOutput)
    if questionToGrade == None:
...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        ...
        evaluate(options.generateSolutions, options.testRoot, moduleDict,
            edxOutput=options.edxOutput, gsOutput=options.gsOutput, muteOutput=options.muteOutput, printTestCase=options.printTestCase,
